...
public class DiaryUI {
    ...
    private static boolean runCommand(String command) {
        ...
        if (commandName.equals("create") && argNum == 1) {
            ...
            if (argNum == 1) {
                diary.listEntries();
            } else if (argNum == 2 && commandSlices[1].equals("title")) {
                diary.listEntriesTitle();
            } else if (argNum == 3 && commandSlices[1].equals("title") && commandSlices[2].equals("length")) {
                diary.listEntriesTitleLength();
            }
